import {
  DomSanitizer
} from "./chunk-7CWVZA5H.js";
import {
  HttpClient
} from "./chunk-Z3QC32YQ.js";
import {
  AsyncPipe,
  CommonModule,
  isPlatformBrowser
} from "./chunk-5KVRB2RP.js";
import {
  ...
  ɵɵtext,
  ɵɵtextInterpolate
} from "./chunk-C4MWYXPW.js";
import {
  merge
} from "./chunk-GE7BWC2S.js";
import "./chunk-VGABMSW2.js";
import {
  Subject,
  __async,
  __spreadProps,
...
var m = {
  ...
  fencesBeginRegex: (l3) => new RegExp(`^ {0,${Math.min(3, l3 - 1)}}(?:\`\`\`|~~~)`),
  headingBeginRegex: (l3) => new RegExp(`^ {0,${Math.min(3, l3 - 1)}}#`),
  htmlBeginRegex: (l3) => new RegExp(`^ {0,${Math.min(3, l3 - 1)}}<(?:[a-z].*>|!--)`, "i")
};
var xe = /^(?:[ \t]*(?:\n|$))+/;
var be = /^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/;
var Re = /^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/;
...
var _e = __spreadProps(__spreadValues({}, K), {
  lheading: Te,
  table: re,
...
var Le = __spreadProps(__spreadValues({}, K), {
...
var We = __spreadProps(__spreadValues({}, N), {
...
var b = class l {
  ...
  inlineQueue;
  constructor(e) {
    this.tokens = [], this.tokens.links = /* @__PURE__ */ Object.create(null), this.options = e || O, this.options.tokenizer = this.options.tokenizer || new y(), this.tokenizer = this.options.tokenizer, this.tokenizer.options = this.options, this.tokenizer.lexer = this, this.inlineQueue = [], this.state = {
      inLink: false,
      inRawBlock: false,
      top: true
    };
